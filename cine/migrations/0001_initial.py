    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "allocine",
                    models.URLField(null=True, verbose_name="Allocin\xe9", blank=True),
                ),
                (
                    "realisateur",
                    models.CharField(
                ...
                (
                    "duree",
                    models.CharField(
                        max_length=20, null=True, verbose_name="Dur\xe9e", blank=True
                    ),
                ),
                (
                    "duree_min",
                    models.IntegerField(null=True, verbose_name="Dur\xe9e en minutes"),
                ),
                ("vu", models.BooleanField(default=False)),
                (
                    "imdb_id",
                    models.CharField(
                        max_length=10, null=True, verbose_name="id IMDB", blank=True
                    ),
                ),
                (
                    "imdb_poster_url",
                    models.URLField(
                        null=True, verbose_name="URL du poster", blank=True
                    ),
                ),
                (
                    "imdb_poster",
                    models.ImageField(null=True, upload_to="cine/posters", blank=True),
                ),
                (
                    "respo",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "favoris",
                    models.ForeignKey(
                        to="cine.Film", null=True, on_delete=models.SET_NULL
                    ),
                ),
                (
                    "hote",
