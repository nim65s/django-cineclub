...
urlpatterns = [
    ...
    path('soiree/<int:pk>', DetailView.as_view(queryset=Soiree.objects.a_venir()), name='soiree'),
    path('soiree/<int:pk>/delete', views.SoireeDeleteView.as_view(), name='delete_soiree'),
